...
OUTPUT_DIR = os.path.join("approach_2_analysis_output",STATE_NAME.replace(" ", "_"))
...
for yr, df in DATA.items():
    print(f"  {yr}  to  {df.shape[0]} categories  ×  {df.shape[1]} districts")

ALL_CATS  = list(DATA[YEAR_LABELS[0]].index)
ALL_DISTS = list(DATA[YEAR_LABELS[0]].columns)

def _save(output_dir, name: str):
...
def process_state(STATE_NAME):
    ...
    plt.tight_layout()
    _save(OUTPUT_DIR,"01_raw_heatmaps.png")
    ...
    plt.tight_layout()
    _save(OUTPUT_DIR,"02_normalised_heatmaps.png")
    ...
    ax.tick_params(axis="y", rotation=0,  labelsize=7)
    plt.tight_layout()
    _save(OUTPUT_DIR,"03_change_heatmap.png")
    ...
    if valid_vals.size == 0:
        ...
        ax.tick_params(axis="y", rotation=0,  labelsize=7)
        plt.tight_layout()
        _save(OUTPUT_DIR,"04_pct_change_heatmap.png")
    ...
    plt.tight_layout()
    _save(OUTPUT_DIR,"05_category_correlation.png")
    ...
    ax.tick_params(axis="y", rotation=0,  labelsize=6)
    plt.tight_layout()
    _save(OUTPUT_DIR,f"06_district_correlation_{yr.replace('-','_')}.png")
    ...
    ax.tick_params(axis="x", rotation=45, labelsize=6)
    plt.tight_layout()
    _save(OUTPUT_DIR,f"08_stacked_bar_{yr.replace('-','_')}.png")
    ...
    plt.tight_layout()
    _save(OUTPUT_DIR,"11_dominant_category_per_district.png")
    ...
    _save(OUTPUT_DIR, "12_L1_category_totals_by_year.png")
